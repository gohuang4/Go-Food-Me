...
import imageIcon from '/images/GoFoodMe-Icon.png';
      ...
      <div className="container-fluid">
        ...
        <nav class="navbar bg-light">
          ...
          <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <div class="center">
            <img class="me-4" src={imageLogo} alt='' width="200"/>
            </div>
            <li className="nav-item">
              <NavLink className="nav-link" to="sign-in"><button class="btn btn-outline-success me-4" type="button">Sign In</button></NavLink>
            </li>
            <li className="nav-item">
              <NavLink className="nav-link" to="sign-up"><button class="btn btn-outline-success me-4" type="button">Sign Up</button></NavLink>
            </li>
          </ul>
        </div>
      </div>
